...
export default props => {
  ...
  const [locations] = useState(["Any Location", "PatioHall", "Ground", "Banquet"]);
      ...
      <Row noGutters className="text-center align-items-center pizza-cta">
        <Col>
          <p className="looking-for-pizza">
            {!selection.room.id ? "Book a Hall " : "Confirm Reservation"}
            <i
              className={
                !selection.room.id
          ...
          <p className="selected-room">
            {selection.room.id
              ? "You are booking Hall with room " + selection.room.name
              : null}
          </p>
